...
<section class="relative overflow-hidden bg-gray-800 text-gray-300">
  <img class="hidden xl:block max-w-2xl absolute bottom-0 right-80 translate-x-1/2 translate-y-1/2 opacity-5" src="polka-dot-pattern.png" alt="Background pattern" aria-hidden="true">

	<div class="relative container px-8 py-12 grid gap-8 md:grid-cols-2 lg:px-4 xl:grid-cols-3 xl:self-start">
