...
<section class="bg-gray-800 text-gray-300">
	<div class="container py-12 px-8 grid gap-8 xl:flex">
		<div class="grid gap-4 xl:ml-8">
			<h2 class="text-xl font-light">بـهترین ویژگی‌های آیدی‌پی</h2>
			<p class="text-sm leading-7 text-justify text-gray-400 font-extralight">درگاه پرداخت اینترنتی آیدی‌پی, امکان ایجاد و مدیریت تراکنش‌های مالی در بستر وب را به راحتی امکان‌پذیر می‌سازد و با پیاده‌سازی راه‌کارهای هوشمندانه, باعث افزایش تراکنش‌های موفق و سوددهی بیش‌تر می‌شود.</p>
		</div>
    ...
    <FeaturesItem
      title="ضمانت پرداخت"
      description="درگاه پرداخت آیدی‌پی, تجربه‌ی پرداخت اینترنتی آسان, سریع و امن را به مشتریان کسب‌وکارهای آنلاین هدیه می‌دهد. سریع‌تر از همیشه, پرداخت‌های اینترنتی خود را به آسانی به انجام برسانید."
      bgColor="bg-sky-800"
    >
