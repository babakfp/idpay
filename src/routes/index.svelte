...
<section class="bg-gray-800 text-gray-300 font-light">
	<div class="container py-8 xl:flex">
		...
		<div class="mt-8 grid gap-8 grid-cols-2 xl:flex xl:mt-0">
			<div>
